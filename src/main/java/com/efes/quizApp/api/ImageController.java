...
import com.efes.quizApp.entity.Image;
import com.efes.quizApp.repository.ImageRepository;
...
@RestController
@RequestMapping(ApiPaths.ImageCtrl.CTRL)
//@Api(value = "Project APIs")
@Api(value = ApiPaths.ImageCtrl.CTRL)
@Slf4j
//@MultipartConfig
